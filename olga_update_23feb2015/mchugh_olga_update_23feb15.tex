...
%10 & pruned chr 20 & autosomes & 1-5
\end{tabular}
\end{table}
...
%\begin{frame}
%Estimate of $\mathbf{\Phi_A}$ in 10,272 autosomal-unrelated samples, using pruned chr 20 SNPs corr for Auto PC 1-5
%\centering
%\begin{figure}
%\includegraphics[height=6cm]{../hist_chr20KC_autoPC15adj_autoUnrel.pdf}
%\includegraphics[height=6cm]{../hist_chr20KC_autoPC15adj_autoUnrel_trunc.pdf}
%\end{figure}
%\end{frame}
...
%\begin{itemize}
%\item We calculate PCs using a pruned set of autosomal SNPs.
%\item We then estimate $\mathbf{\Phi_{20}}$ using a pruned set of chromosome 20 SNPs, correcting for PCs 1-5 on the autosomes\footnote{unrelated kinship threshold of 0.1}.
%\item Finally, we take the eigendecomposition of $\mathbf{\Phi_{20}}$, after subsetting to unrelated samples.
%\end{itemize}
%The eigendecomposition should yield any structure on chromosome 20 that wasn't already corrected for in the adjustment for autosomal PCs 1-5.
%\end{frame}
%
%\begin{frame}
%\centering
%\begin{figure}
%\includegraphics[height=8.5cm]{../eigen_unrel_adjchr20kc_adjAutoPC15_ev12_col.png}
%\end{figure}
%\end{frame}
%
%\begin{frame}
%\begin{figure}
%\includegraphics[height=8.5cm]{../eigen_unrel_adjchr20kc_adjAutoPC15_ev34_col.png}
%\end{figure}
%\end{frame}
%
%\clearpage
...
%\begin{itemize}
%\item We calculate PCs using a pruned set of autosomal SNPs.
%\item We then estimate $\mathbf{\Phi_A}$ using a pruned set of autosomal SNPs, correcting for PCs 1-5 on the autosomes \{\textcolor{blue}{model 9}\}.
%\item Finally, we take the eigendecomposition of $\mathbf{\Phi_A}$, after subsetting to unrelated samples.
%\end{itemize}
%The eigendecomposition should yield any structure on the autosomes that wasn't already corrected for in the adjustment for autosomal PCs 1-5.
%\end{frame}
%
%\begin{frame}
%\centering
%\begin{figure}
%\includegraphics[height=8.5cm]{../eigen_unrel_adjAutokc_adjAutoPC15_ev12_col.png}
%\end{figure}
%\end{frame}
%
%\begin{frame}
%\begin{figure}
%\includegraphics[height=8.5cm]{../eigen_unrel_adjAutokc_adjAutoPC15_ev34_col.png}
%\end{figure}
%\end{frame}
%
%\begin{frame}
%\begin{figure}
%\includegraphics[height=8.5cm]{../eigen_unrel_screes_ev115.pdf}
%\end{figure}
%\end{frame}
